...
public class AbstractAimAnswerAction extends BaseAction {

	public String infolet() {
		Long cazeId = getEntityId("caze");
		String type = get("type");
		if (StringUtils.isNotEmpty(type)) {
			EntityQuery query = new EntityQuery(getTypeName(type), "a");
	...
	private String getTypeName(String type) {
		return "org.expr.model.aim.answer." + type + "Answer";
	}
