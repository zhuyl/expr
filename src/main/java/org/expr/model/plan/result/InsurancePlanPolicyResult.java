 ...
 * 
 */
public class InsurancePlanPolicyResult extends LongIdObject {
    
    /** 保险资产 */
    private InsurancePlanResult result;
	...
	/**主险保单*/
	private InsurancePlanPolicyResult master;

	public InsurancePlanResult getResult() {
		return result;
	}

	public void setResult(InsurancePlanResult result) {
		this.result = result;
	}
	...
	public InsurancePlanPolicyResult getMaster() {
		return master;
	}

	public void setMaster(InsurancePlanPolicyResult master) {
		this.master = master;
	}
