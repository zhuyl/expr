 ...
 * 
 */
public class FinancePlanAnswer extends LongIdObject {

	private FinanceAssetPlanAnswer answer;
/**风险等级*/
	RiskGrade riskgrade;
/**资产类型*/
...
/***流动性*/
	...
	public FinanceAssetPlanAnswer getAnswer() {
		return answer;
	}

	public void setAnswer(FinanceAssetPlanAnswer answer) {
		this.answer = answer;
	}
