...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCFF" style="border-collapse:collapse;" >
  <tr> 
    <td height="23" background="${base}/static/images/titlebg.gif"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td><img src="${base}/static/images/titlearrow.gif" width="8" height="13"> <span class="title"><strong>住房公积金计算器</strong></span></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td> <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td height="25" class="explain"><B>住房公积金计算器可以帮您计算今年您每月缴存的住房公积金金额</B></td>
        </tr>
      </table>
            ...
            cellPadding=0 width=651 border=0>
                <TBODY>
                  ...
                  width=156 height="25" class=zhengwen>单位缴存比例:</TD>
                    <TD width=495 height="25" class="zhengwen"> <input type="text" name="danWeiBiLi" id="danWeiBiLi" class="inputBox" style="width: 80px" />
                      %</TD>
                  </TR>
                  <TR>
                    <TD height=25 class="zhengwen">个人缴存比例：</TD>
                    <TD height=25 class="zhengwen">
<input type="text" name="geRenBiLi" id="geRenBiLi" class="inputBox" style="width: 80px" />
                       %</TD>
                  </TR>
                  <TR> 
                    <TD height=25>&nbsp; </TD>
                    <TD height=25><img id=btnCalc
                  style="CURSOR: hand" onClick="GongJiJin();" tabindex=7 
          ...
          <TR> 
            <TD ><TABLE width="81%" height="25"  border="0" cellpadding="0" cellspacing="0" >
                <TBODY>
                  <TR> 
                    <TD width="32%" height="25" align=left class=zhengwen >今年您每月缴存的住房公积金：</TD>
                    <TD width="68%" height="25" align=left class=zhengwen >
<input type="text" name="jiaoCun" id="jiaoCun" value="计算得出" disabled class="inputBox" style="width: 100px; " />
                      元</TD>
                  </TR>
                  <TR>
                    <TD height="25" align=left class=zhengwen >其中单位缴存：</TD>
                    <TD height="25" align=left class=zhengwen ><input type="text" name="danWeiJiaoCun" id="danWeiJiaoCun" value="计算得出" disabled class="inputBox" style="width:100px; " /> 元</TD>
                  </TR>
                  <TR>
                    <TD height="25" align=left class=zhengwen >个人缴存：</TD>
                    <TD height="25" align=left class=zhengwen ><input type="text" name="geRenJiaoCun" id="geRenJiaoCun" value="计算得出" disabled class="inputBox" style="width: 100px;" /> 元</TD>
                  </TR>
                </TBODY>
              </TABLE></TD>
          </TR>
          ...
          <TR> 
            ...
            <TD valign="top" class="zhengwen">通过本计算器，可以根据您上年度平均月工资及您所在市职工上年度平均月工资与单位缴存比例及个人缴存比例计算出今年您每月缴存的住房公积金、单位缴存及个人缴存。</TD>
          </TR>
        </TBODY>
      </TABLE>
	</td>
