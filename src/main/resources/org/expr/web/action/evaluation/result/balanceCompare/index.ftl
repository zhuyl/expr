<#include "/template/head.ftl"/>
 <body >
 	<form name="editForm" method="post" action="${base}/result/balanceCompare!saveRemark.action">
 <table id="gpBar"></table>
 <script>  
  function incomeExpense(year){
     self.location="balanceCompare.action?faceyear="+year+"&experiment.id=${Parameters['experiment.id']}";
  }
