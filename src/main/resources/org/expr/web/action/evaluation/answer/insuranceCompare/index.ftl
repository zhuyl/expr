<#include "/template/head.ftl"/>
 <body >
  	<form name="editForm" method="post" action="${base}/answer/insuranceCompare!saveRemark.action">
 <table id="gpBar"></table>
 <script>  
  function insuranceAnalysis(year){
     self.location="insuranceCompare.action?faceyear="+year+"&caze.id=${Parameters['caze.id']}";
  }
