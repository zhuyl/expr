<#include "/template/head.ftl"/>
 <body >
  	<form name="editForm" method="post" action="${base}/answer/financeCompare!saveRemark.action">
 <table id="gpBar"></table>
 <script>  
  function financeAssetAnalysis(year){
     self.location="financeCompare.action?method=index&faceyear="+year+"&caze.id=${Parameters['caze.id']}";
  }
