...
cellPadding=0 cellSpacing=0 id=mainTable style="WIDTH: 100%; HEIGHT: 70%">
  <TBODY>
    ...
    <TR> 
      ...
      <IFRAME name=resultLeftFrame src="resultDashboard!analysisTree.action?experimentId=${experimentId}" frameBorder=0 
      ...
      <IFRAME id=resultMain name=resultMain 
      src="${base}/studyLog!studyLogs.action?experimentId=${experimentId}" 
