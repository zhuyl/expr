...
<#assign labInfo><@text name="家庭基本信息" /></#assign>
  <table width="90%" align="center" class="formTable">
    ...
    <tr>
     ...
     <td><input type="text" name="familyMemberAnswer.member.birthday" maxlength="10" value="${(familyMemberAnswer.member.birthday?string('yyyy-MM-dd'))?if_exists}" onfocus="calendar()"/></td>
    </tr> 
    <tr>
...
<script language="javascript" > 
    function save(form){
         var a_fields = {
             ...
             'familyMemberAnswer.member.birthday':{'l':'出生日期', 'r':true,'t':'f_birthday'},
             'familyMemberAnswer.member.age':{'l':'年龄', 'r':true, 't':'f_age','f':'unsigned'},
             'familyMemberAnswer.member.career.id':{'l':'职业', 'r':true,'t':'f_job'},
