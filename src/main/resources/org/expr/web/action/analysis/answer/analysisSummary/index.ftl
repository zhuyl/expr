...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <input name="analysisSummaryAnswer.id" value="${answer.id}" type="hidden">
    <input name="params" value="&caze.id=${answer.caze.id}" type="hidden">
    <textarea id="remark" name="analysisSummaryAnswer.remark"  style="font-size:10pt;width:100%;height:200px">${answer.remark!}</textarea>
    </form>
    </td>
  </tr>
</table>
