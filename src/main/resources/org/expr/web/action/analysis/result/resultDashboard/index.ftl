...
cellPadding=0 width="100%" border=0>
  ...
  <TR>
   <td><IFRAME HEIGHT="100%" WIDTH="100%" 
	       FRAMEBORDER="0" src="resultDashboard!experimentDetail.action?experimentId=${experimentId}"
...
cellPadding=0 cellSpacing=0 id=mainTable style="WIDTH: 100%; HEIGHT: 70%">
  <TBODY>
    ...
    <TR> 
      ...
      <IFRAME 
      name=resultLeftFrame src="resultDashboard!analysisTree.action?experimentId=${experimentId}" frameBorder=0 
      ...
      <IFRAME id=answerMain name=answerMain scroll="auto" src="${base}/studyLog!studyLogs.action?experimentId=${experimentId}" frameBorder=0 width="100%" height="100%"></IFRAME>
      </TD>
    </TR>
  </TBODY>
</TABLE>
