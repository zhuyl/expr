...
<table id="taskBar"></table>
  <table class="formTable" align="center" width="80%">
	<form name="editForm" method="post" action="${base}/result/incomeExpense!saveRemark.action">
...
<form name="actionForm" method="post" action="incomeExpense.action?method=saveIncomeExpense">
 ...
 <tr height="22"> 
  ...
  <tr height="22"> 
    ...
    <td class="brightStyle" colspan="2"><input readOnly name="result.form.totalIncome" type="text" value="${(result.form.totalIncome)?if_exists}" style="width:100%"/></td>
    <td class="grayStyle" id="f_totalExpend"><strong>总支出</strong></td>
    <td class="brightStyle" colspan="2"><input readOnly name="result.form.totalExpend" type="text" value="${(result.form.totalExpend)?if_exists}" style="width:100%"/></td>
  </tr>
  <tr height="22">
    <td class="grayStyle" id="f_totalBalance"><strong>总结余</strong></td>
    <td colspan="5" class="brightStyle"><input  readOnly name="result.form.totalBalance" type="text" value="${(result.form.totalBalance)?if_exists}" style="width:100%"/></td>
  </tr>
  <tr> 
