...
<table id="taskBar"></table>
  <table class="formTable" align="center" width="80%">
	<form name="editForm" method="post" action="${base}/answer/changeAnalysis!saveRemark.action">
...
第${changeYear}年的收支表
 ...
 <tr height="22"> 
  ...
  <tr height="22"> 
    ...
    <td class="brightStyle" colspan="4">${(totalincome)?if_exists},调整后:<input readOnly name="answer.form.totalIncome" type="text" value="${(totalchangeincome)?if_exists}" style="width:100px"/></td>
    <td class="grayStyle" id="f_totalExpend"><strong>总支出</strong></td>
    <td class="brightStyle" colspan="4">${(totalexpend)?if_exists},调整后:<input readOnly name="answer.form.totalExpend" type="text" value="${(totalchangeexpend)?if_exists}" style="width:100px"/></td>
  </tr>
  <tr height="22">
    <td class="grayStyle" id="f_totalBalance"><strong>总结余</strong></td>
    <td colspan="9" class="brightStyle">${(totalbalance)?if_exists},调整后:<input  readOnly name="answer.form.totalBalance" type="text" value="${(totalchangebalance)?if_exists}" style="width:100px"/></td>
  </tr>
  <tr> 
