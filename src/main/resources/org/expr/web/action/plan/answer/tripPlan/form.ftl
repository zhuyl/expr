...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/answer/tripPlan!save.action">
		<input type="hidden" name="params" value="&caze.id=${Parameters['caze.id']}">
		<input type="hidden" name="caze.id" value="${Parameters['caze.id']}">
		<tr><td class="title" id="f_expense"><font color="red">*</font>旅游支出</td><td><input id="expense" name="expense"/></td></tr>
  ...
  <script language="javascript">
     var bar = new ToolBar("toolbar","旅游支出规划",null,true,true);
    ...
    function save(form){
         var a_fields = {
             'expense':{'l':'旅游支出','r':true,'t':'f_expense','f':'unsignedReal'},
