...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/result/estateLoanPlan!saveHouseForm.action">
		...
		<tr><td class="title" id="f_expense"><font color="red">*</font>房产价值</td><td><input id="expense" name="expense" value="${(result.houseCapital)!}"/></td></tr>
