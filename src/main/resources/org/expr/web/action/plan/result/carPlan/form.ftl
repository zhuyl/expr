...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/result/carPlan!save.action">
		...
		<tr ><td class="title" id="f_capital"><font color="red">*</font>贷款总额</td><td colspan="3"><input id="capital" name="capital" value="${(result.businessCapital)!}">元</td></tr>
