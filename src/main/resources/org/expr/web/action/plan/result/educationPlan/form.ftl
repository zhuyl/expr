...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/result/educationPlan!save.action">
		...
		<tr><td class="title">姓名</td><td>${member.name}<input type="hidden" name="name" value="${member.name!}"/></td></tr>
		<tr><td class="title" id="f_expense"><font color="red">*</font>教育支出</td><td><input id="expense" name="expense"/></td></tr>
  ...
  <script language="javascript">
     var bar = new ToolBar("toolbar","教育支出规划",null,true,true);
    ...
    function save(form){
         var a_fields = {
             'expense':{'l':'教育支出','r':true,'t':'f_expense','f':'unsignedReal'},
