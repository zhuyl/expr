...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/result/bonusPlan!save.action">
		...
		<tr><td class="title" id='f_bonus'><font color="red">*</font>奖金收入</td><td><input id="bonus" name="bonus" value=""/></td></tr>
  ...
  <script language="javascript">
     var bar = new ToolBar("toolbar","奖金收入规划",null,true,true);
  ...
  <script language="javascript" > 
    function save(form){
         var a_fields = {
             'bonus':{'l':'奖金收入','r':true,'t':'f_bonus','f':'unsignedReal'},
