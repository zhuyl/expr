...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/answer/medicalPlan!save.action">
		...
		<tr><td class="title" id="f_expense">医疗支出</td><td><input id="expense" name="expense"/></td></tr>
  ...
  <script language="javascript">
     var bar = new ToolBar("toolbar","医疗支出规划",null,true,true);
    ...
    function save(form){
         var a_fields = {
             'expense':{'l':'医疗支出','r':true,'t':'f_expense','f':'unsignedReal'},
