...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/answer/carPlan!save.action">
		...
		<tr ><td class="title" id="f_capital"><font color="red">*</font>贷款总额</td><td colspan="3"><input id="capital" name="capital" value="${(answer.businessCapital)!}">元</td></tr>
		<tr class="darkColumn" align="center"><td colspan="4"><input type="button" onClick='save(this.form)' value="提交"></td></tr>
		</form>
	</table>

  <script language="javascript">
     var bar = new ToolBar("toolbar","购车规划",null,true,true);
