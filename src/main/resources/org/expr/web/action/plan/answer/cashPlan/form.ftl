...
<table id="toolbar"></table>
	...
	<form name="actionForm" method="post" action="${base}/answer/cashPlan!save.action">
		...
		<tr><td class="title" id='f_salary'><font color="red">*</font>工作收入</td><td><input id="salary" name="salary" value=""/></td></tr>
  ...
  <script language="javascript">
     var bar = new ToolBar("toolbar","工作收入规划",null,true,true);
  ...
  <script language="javascript" > 
    function save(form){
         var a_fields = {
             'salary':{'l':'工作收入','r':true,'t':'f_salary','f':'unsignedReal'},
