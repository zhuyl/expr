     ...
     <table width="100%">       
		   ...
		   <tr>
		   	 ...
		   	 <td >
		   	   ...
		   	   <div id="show">
		   	  	<input id="receiptorIds" type="hidden" name="receiptorIds" value="${Parameters['studentId']}">
		   	  	<textarea id="receiptorNames" name="receiptorNames" rows="2" cols="60" readonly style="font-size:10pt">${studentNames}</textarea>
	...
	<script>
		...
		function doAction(){
	     ...
	     if (v.exec()) {
	        ...
	        document.listForm.action="lessonMessage!sendToStudent.action";
