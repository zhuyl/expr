...
<table width="100%" height="93%" class="frameTable">
   ...
   <td valign="top" class="frameTable_view" width="17%" style="font-size:10pt">
      <table  width="100%" id ="viewTables" style="font-size:10pt">
       ...
       <tr>
         <td class="padding" onclick="newSystemMessage(this,'teacher')"  onmouseover="MouseOver(event)" onmouseout="MouseOut(event)">
          &nbsp;&nbsp;<image src="${base}/static/images/action/new.gif">发送到教师
         </td>
       </tr>
	  </table>
	<td>
