                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="150"><table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="25" colspan="2" class="text"><strong>&nbsp;&nbsp;您好！${user.fullname}老师</strong></td>
                                </tr>
                                <tr> 
                ...
                <td valign="top">
                    ...
                    <tr> 
                      <td align="center" valign="middle" background="${base}/static/images/leftbg.gif"> 
                        <form name="casebase" target="_blank" action="myCaze.action">
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td height="25" colspan="2" class="text">案例名称： 
                                <input name="caze.name" type="text"  size="15"></td>
                            </tr>
                            <tr> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td height="74" align="center" valign="middle" background="${base}/static/images/leftbg.gif">
                        <table width="95%" border="0" cellspacing="0" cellpadding="0">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td align="center"  valign="top" valign="top" height="100%">
          <iframe src="teacherLesson.action" width="100%" height="100%"></iframe>
          </td>
        </tr>
      </table>
    </td>
