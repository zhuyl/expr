...
<script>
 window.history.go(+1);
  ...
  bar.addPrint();
	...
	<tr>
		<td align="right">学生姓名(学号)：</td><td align="left"><B>${std.name}(${std.code})</B></td><td align="right">得分：</td><td align="left"><B><font color="#FF0000">${examPaperResult.mark!}</font></B></td>
	</tr>
	<tr>
	...
	<#if (currentTime?datetime>=examPaperResult.paper.endAt)>
		<table align="center" width="90%">
	<tr>
